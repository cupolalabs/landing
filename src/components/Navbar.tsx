...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 md:left-1/2 md:top-8 md:right-auto md:transform md:-translate-x-1/2 z-50 w-full md:w-[100vw] md:max-w-[672px]">
      <div className="backdrop-blur-lg bg-white/10 border-b border-white/20 rounded-none md:rounded-3xl h-16 md:h-20 w-full flex flex-row items-center justify-between px-4 md:px-8 py-3 md:py-0 md:border md:border-white/20 md:border-b-0">
